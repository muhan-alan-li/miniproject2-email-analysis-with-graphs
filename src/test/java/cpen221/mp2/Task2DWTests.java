...
public class Task2DWTests {
    ...
    private static UDWInteractionGraph empty;
    private static UDWInteractionGraph invalid;
    ...
    public static void setupTests() {
        ...
        empty = new UDWInteractionGraph("resources/empty.txt");
        invalid = new UDWInteractionGraph("resources/invali.txt");
    }
    ...
    public void testReportOnUserBase() {
        //System.out.println(Arrays.toString(dwig.ReportOnUser(0)));
        //System.out.println(Arrays.toString(dwig.ReportOnUser(8)));
    ...
    public void testNoActiveUser() {
        ...
        System.out.println("error should be here.");
    }
}
