...
public class Task2UDWTests {
    ...
    public void testweird() {
        DWInteractionGraph t = new DWInteractionGraph("resources/Task3-components-test2.txt");
        UDWInteractionGraph u = new UDWInteractionGraph(t);
        Assertions.assertEquals(2,u.getEmailCount(1,1));
    }
